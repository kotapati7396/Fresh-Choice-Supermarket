...
b:
	cout << "\n\n"
		 << endl;
	system("color 02");
	cout << "============================================ WELCOME TO Fresh Choice Supermarket ===========================================" << endl;
	cout << "\t                                  ....a place to buy your ....                                          \n\n"
		 << endl;
	cout << "\t\t\t\t\t[1]. Admin Portal\n"
		 << endl;
	...
	case 1:
		...
		if (option == 1)
		{
			...
			cout << "\n\t\t\tCongratulation!.... you are being successfully registered and kotapati Fresh Choice Supermarket" << endl;
			cout << "\n\t\t\t\t\t";
			system("PAUSE");
